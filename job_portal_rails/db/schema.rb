...
ActiveRecord::Schema.define(version: 2023_08_26_201207) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.bigint "company_creator_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_creator_id"], name: "index_companies_on_company_creator_id"
  end
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.integer "openings"
    t.integer "status"
    t.bigint "job_creator_id", null: false
    t.bigint "company_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_id"], name: "index_jobs_on_company_id"
    t.index ["job_creator_id"], name: "index_jobs_on_job_creator_id"
  end
  ...
  add_foreign_key "companies", "users", column: "company_creator_id"
